...
class ShiftRequirement(models.Model):
    ...
    day_of_week = models.CharField(max_length=10, unique=True, choices=DAY_CHOICES)
    ...
    def __str__(self):
        return f"{self.day_of_week}：Ns={self.nurse_required}, CE={self.engineer_required}, 助={self.assistant_required}, 計={self.total_required}"
