...
template_dir = Path("shifts/static/templates_generated")
template_dir.mkdir(parents=True, exist_ok=True)

powershell_script_path = Path("generate_all_templates.ps1")
...
# スクリプト書き出し
powershell_script_path.write_text(powershell_code, encoding='utf-8')
print(f"✅ PowerShellスクリプト生成完了: {powershell_script_path}")
